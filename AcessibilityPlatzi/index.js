...
function validateForm(e) {
  ...
  if (nameField.value === "") {
    document.getElementById('name-error').innerHTML = 'You must enter a name to be able to send the form!';
...
function showNotification() {
  ...
  document.querySelector('.notification').innerHTML = 'The form was sent successfully!';
...
function openModal(e) {
  ...
  document.querySelector("#img-modal-capture").setAttribute("src", img);
}
